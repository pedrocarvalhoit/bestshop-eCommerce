package com.bestshop.admin.shippingrate;
...
public class ShippingRateRepositoryTests {
    ...
    public void testCreateNew() {
        ...
        org.assertj.core.api.Assertions.assertThat(savedRate).isNotNull();
        org.assertj.core.api.Assertions.assertThat(savedRate.getId()).isGreaterThan(0);
    }
    ...
    public void testUpdate() {
        ...
        org.assertj.core.api.Assertions.assertThat(updatedRate.getRate()).isEqualTo(9.15f);
        org.assertj.core.api.Assertions.assertThat(updatedRate.getDays()).isEqualTo(2);
    }

    @Test
    public void testFindAll() {
        List<ShippingRate> rates = (List<ShippingRate>) repo.findAll();
        org.assertj.core.api.Assertions.assertThat(rates.size()).isGreaterThan(0);
    ...
    public void testFindByCountryAndState() {
        ...
        org.assertj.core.api.Assertions.assertThat(rate).isNotNull();
    ...
    public void testUpdateCODSupport() {
        ...
        ShippingRate rate = entityManager.find(ShippingRate.class, rateId);
        org.assertj.core.api.Assertions.assertThat(rate.isCodSupported()).isFalse();
    }
